...
- **Optimal Pathing:** [Computes the optimal path between two points within the area.](https://github.com/lag25?tab=repositories](https://github.com/lag25/ForestPathPlanner)](https://github.com/lag25/ForestPathPlanner)
